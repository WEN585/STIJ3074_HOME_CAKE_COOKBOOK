...
if($lastInsertId)
{
    echo "<script>alert('Congratulations, your are our member now!'); window.location='index.php'</script>";

}
else 
{
 echo "<script>alert('Something went wrong.Please try again'); window.location='signup.php'</script>";
}
}
 else
{
 echo "<script>alert('Username or Email-id already exist. Please try again'); window.location='signup.php'</script>";
}
}
?>
...
<head>
    <meta charset="utf-8">
    <title>Home Cake Cookbook | Registration Form</title>
 ...
 <div class="control-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <button type="cancel" name="cancel" class="btn btn-primary"><a href="index.php">Cancel</button>
